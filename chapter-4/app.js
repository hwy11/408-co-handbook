const CHAPTER = {
  ...
  title: "指令系统",
  sections: [
    { id: "4-talk", num: "导读", title: "本章串讲", subs: ["第四章指令系统串讲"], lead: "", blocks: [], exam: [] },
    {
      id: "4-1",
      num: "4.1",
      title: "指令系统",
...
function renderSection(sec){if(sec.id==="4-talk")return window.renderChapterTalk?window.renderChapterTalk("4"):`<div class="card">本章串讲内容加载中...</div>`;return `${renderDeep(sec)}<div class="card"><h3 class="h3" style="margin-top:0">408 抓分点</h3><ul>${sec.exam.map(item=>`<li>${item}</li>`).join("")}</ul></div>`;}
